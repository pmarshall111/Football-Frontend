export const faqs: {question: string, answer: string}[] = [{
    ...
    answer: "A Logistic Regression algorithm has been trained on over 10,000 previous games. " +
        "The algorithm looks at 20 features in all - chosen by picking the features with the best R correlation to the final score." +
        " The features include over things like the difficulty of previous games, xG, H2H between the teams," +
        " goals scored... and more that you'd expect. These stats are calculated for upcoming games and run through the algorithm, creating a prediction. " +
