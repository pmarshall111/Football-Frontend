            ...
            <div className={"perf-info"}>
                <div>
                    ...
                    <div className={"perf-chart"}>
                        <LineChart data={series} currMatch={currMatch} updateCurr={(obj:{idx: number, from: string}) => setCurrMatch(obj)} />
                    </div>
                </div>
                <div>
                    <h5>Total Bets: 60 (1.1/week AVG)</h5>
                    <div className={"perf-chart perf-table"}>
                        <BetDisplay data={betHistory} currMatch={currMatch} updateCurr={(obj:{idx: number, from: string}) => setCurrMatch(obj)}/>
                    </div>
                </div>
            </div>
        </div>
