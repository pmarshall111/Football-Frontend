...
const TitleLayout = (props: any) => {
    return (
        <div className={"title-layout"}>
            ...
            <h3>Providing AI recommended bets with a 35% profit since the 2019/20 season.</h3>
            <div>
                <Button onClick={() => scrollTo("predictions")} variant={"primary"}>Recommendations</Button>
